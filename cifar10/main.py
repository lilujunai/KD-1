...
scheduler1 = torch.optim.lr_scheduler.CosineAnnealingWarmRestarts(optimizer, T_0=15)
scheduler2 = torch.optim.lr_scheduler.MultiStepLR(optimizer, milestones=[150,250,350], gamma=0.1)
